...
import DropdownLogo from '@/components/ui/Dropdown/DropdownLogo.vue'
...
import ToggleSpeech from '@/components/ui/Toggle/ToggleSpeech.vue'
...
<template>
  ...
  >
    ...
    <div
      class="gap-0.5 grid"
      :class="isMobile ? 'grid-cols-7' : 'grid-cols-8'"
    >
      <DialogInfo />
      <DialogSettings />
      <DialogCommandMenu />
