  ...
  <ContextMenuRoot>
    <ContextMenuTrigger as-child>
      ...
      >
        ...
        >
          <div class="my-1 text-sm font-medium line-clamp-1">
    ...
    <ContextMenuPortal>
      ...
      >
        ...
        <ContextMenuItem
          class="cursor-default text-xs flex justify-between items-center h-7 px-2 hover:bg-primary/20 outline-hidden data-highlighted:bg-destructive/60"
          @click="handleDelete"
        >
