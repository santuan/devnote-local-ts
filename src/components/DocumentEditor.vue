  ...
  <div :key="database.loaded_id">
    <article class="editor" :style="`--editorToolbar:${height + 60}px`">
      ...
      <button
        ...
        class=" absolute right-1 select-none! bottom-0 z-20 h-10 px-3 text-xs text-center left-2 GuardarDocumento disabled:text-foreground/50 focus:bg-primary/50"
        :class="[
