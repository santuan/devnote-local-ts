...
<template>
  ...
  <div>
    <header
      class="fixed top-0 print:hidden z-72 select-none! flex flex-col justify-start h-screen border-r lg:sticky bg-background focus-within:ring-1 border-secondary! focus-within:ring-primary/50 focus-visible:outline-dashed"
      :class="document.show_sidebar_documents ? 'min-w-80 max-w-80' : 'hidden '"
    >
      <SidebarTop />
      <SidebarDocuments />
    </header>
