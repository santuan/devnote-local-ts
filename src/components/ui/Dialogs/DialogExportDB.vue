...
<template>
  <DialogRoot v-model:open="show_export_db">
    <DialogPortal>
      ...
      <DialogContent
        class="font-mono fixed top-24 md:top-[50%] left-[50%] max-h-[85vh]  translate-x-[-50%] translate-y-[-50%] rounded-[6px] bg-background p-3 md:p-6 md:pt-4 shadow-sm focus:outline-hidden z-800"
      >
