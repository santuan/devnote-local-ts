...
<template>
  <div ref="containerRef" class="relative">
    <div
      ...
      class="absolute top-0 left-0 right-0 flex bg-linear-to-b from-background to-transparent items-center justify-center transition-transform py-2 px-5 duration-200 z-299"
      :style="{
    ...
    >
      ...
      >
        ...
        />
        <span v-if="!isRefreshing" class="font-bold">
